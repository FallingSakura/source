...
$.ajax({
    ...
    data: {
        key: 'GAMBZ-J7QHT-VXOXV-LVISC-DNKM2-SFBR5',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showwelcome() {
    ...
    let dist = getDistance(121.514836, 37.424772, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
    ...
    //自定义文本需要放的位置
    document.getElementById("welcome-info").innerHTML = `欢迎来自<span>${pos}</span>的小伙伴，${timeChange}<br>你距离FallingSakura约有<span>${dist}</span>公里，${posdesc}`;
}
}